...
# 
# ATTENZIONE: questo file sostituisce run_queue_all.sh.
# Rinominarlo:  mv run_queue_all_v2.sh run_queue_all.sh
#
...
# Ordine per mole di lavoro residuo, misurato il 2026-08-06.
# Ortega y Gasset RIMOSSO dalla coda: già tradotto.
AUTHORS=(
