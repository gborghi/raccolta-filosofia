---
title: "On Breath (481a)"
philosopher: "Aristotle"
lang: "en"
edizione: "Delphi Classics"
traduttore: "J. F. Dobson"
anno_edizione: 2013
pd_year: 1900
kind: "work"
tags:
...
What then is the [method](/axes/method)? Clearly we must suppose that the breath is nourished by drawing and digesting nutriment from the vein-system, for the blood is the ultimate and universal nutriment. So the breath receives nutriment into the hot element as into its vessel and receptacle.
...
Che cos'è dunque il [metodo](/axes/method)? Chiaramente dobbiamo supporre che il respiro sia nutrito traendo e digerendo nutrimento dal sistema venoso, poiché il sangue è il nutrimento ultimo e universale. Così il respiro riceve nutrimento nell'elemento caldo come nel suo vaso e ricettacolo.
...
What then is the soul? They make it out to be a [potentiality](/concepts/act_potency) which is the cause of such a motion as this. Or is it clear that you will not be right in impugning those who say it is the rational and spirited faculty? for they too refer to these as potentialities.
...
Che cos'è dunque l'anima? Essi la fanno essere una [potenzialità](/concepts/act_potency) che è causa di un moto siffatto. O è chiaro che non avrai ragione nell'impugnare coloro che dicono che essa è la facoltà razionale e quella irascibile? Poiché anch'essi si riferiscono a queste come potenzialità.
...
At the same time a [final cause](/concepts/four_causes) must exist — under which head some class the originator of motion; i.e. the spinal marrow and the brain.
...
Allo stesso tempo deve esistere una [causa finale](/concepts/four_causes) — sotto quale capo alcuni classificano l'origine del movimento; cioè il midollo spinale e il cervello.
