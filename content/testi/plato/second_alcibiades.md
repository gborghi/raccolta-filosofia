...
<div class="atom-reader" data-work="testi/plato/second_alcibiades" data-philosopher="Plato"></div>


<span class="atom-split" data-atom="001" data-title="SECOND ALCIBIADES" data-chapter="" data-kind="intro" data-srclang="en"></span>
...
SOCRATES: And must every sick person either have the gout, or be in a fever, or suffer from ophthalmia? Or do you believe that a man may [labour](/concepts/labour) under some other disease, even although he has none of these complaints? Surely, they are not the only maladies which exist?
...
SOCRATES: You certainly would when you saw each of them rivalling the other and esteeming that of the greatest importance in [the state](/concepts/state),
