...
It is from the value-concept that use-value and exchange-value are supposed to be derived d’abord[13] by Mr. Wagner, not as with me from a concretum, the commodity, and it is interesting to follow this scholasticism in its latest Grundlegung.[14]
...
As for the causes of debt //causes of pauperism: fluctuations in the harvest, war service, slave competition// in Ancient Rome (Jhering, 3rd ed., p. 234, II, 2. Geist des römischen Rechts).[40]
