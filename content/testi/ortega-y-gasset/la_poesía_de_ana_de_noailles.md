---
title: "La poesía de Ana de Noailles"
...
<div class="atom-reader" data-work="testi/ortega-y-gasset/la_poesía_de_ana_de_noailles" data-philosopher="Ortega y Gasset"></div>


<span class="atom-split" data-atom="001" data-title="La poesía de Ana de Noailles" data-chapter="" data-kind="intro" data-srclang="es"></span>
...
Comme une flèche oblique ancrée au [coeur](/positions/fideism) du soir.
...
Una vez filiada como planta [sublime](/concepts/sublime), no nos extraña que sea «rebelde al otoño» y le dedique un sincero vejamen:
...
Once classified as a plant [sublime](/concepts/sublime), it does not surprise us that she is 'rebellious to autumn' and dedicates to it a sincere vituperation:
...
Una volta classificata come pianta [sublime](/concepts/sublime), non ci stupisce che sia «ribelle all'autunno» e gli dedichi un sincero vituperio:
...
Deux êtres luttent dans mon [coeur](/positions/fideism):
...
Deux êtres luttent dans mon [heart](/positions/fideism):
...
Deux êtres luttent dans mon [cuore](/positions/fideism):
