---
title: "Sobre el punto de vista en las artes"
...
A estas diferencias en el [modo](/concepts/mode) de mirar es preciso agregar otra más importante.
...
To these differences in the [mode](/concepts/mode) of looking it is necessary to add another, more important one.
...
A queste differenze nel [modo](/concepts/mode) di guardare è preciso aggiungere un'altra più importante.
